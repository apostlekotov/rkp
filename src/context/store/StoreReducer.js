import { ADD_PRODUCT_TO_CART, INCREASE, DECREASE, REMOVE_PRODUCT_FROM_CART } from "../ActionTypes";
...
const removeProductFromCart = (product, state) => {
    const updatedCart = [...state.cart];
    const updatedProductCartId = updatedCart.findIndex(item => item.id === product.id);
