									...
									<div key={product.id} className='cart-product-wrapper'>
										<table>
											<tbody>
												<tr>
													<td>
														<img src='https://ikrahouse.com.ua/images/45/ikra-foreli-tm-paramush-100g-st.b.-70338125993754_small10.jpg' />
													</td>
													<td>
														<h3>{product.title}</h3>
														{product.weight}г
													...
													<td>
														<button
															className='btn-count'
															onClick={storeContext.decrease.bind(
																this,
																product
															)}
														>
														...
														<button
															className='btn-count'
															onClick={storeContext.increase.bind(
																this,
																product
															)}
														>
								...
								<div className='cart-total-price'>
									<h3>
										...
										<b>
											{storeContext.cart.reduce((count, currentProduct) => {
												return (
													count + currentProduct.quantity * currentProduct.price
												);
											}, 0)}
											грн
										</b>
